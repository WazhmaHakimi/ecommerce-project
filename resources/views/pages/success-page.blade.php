...
new #[Title('Order Success | E-Commerce')] class extends Component {};
?>

<div class="w-full max-w-[85rem] px-6 sm:px-10 md:px-16 lg:px-24 py-8 sm:py-12 lg:py-16 mx-auto min-h-screen">
    <div class="bg-white border rounded-md dark:border-gray-900 dark:bg-gray-900 p-4 sm:p-6 md:p-10">
            ...
            <div class="flex items-start justify-start flex-shrink-0">
                <div class="flex items-center justify-center w-full pb-6 space-x-4 md:justify-start">
                    <div class="flex flex-col items-start justify-start space-y-2">
                        ...
                        <p class="text-sm leading-4 text-gray-600 dark:text-gray-400">Castro Valley, Delaware, 53476-0454
                        </p>
        ...
        <div class="flex flex-wrap items-center pb-4 mb-10 border-b border-gray-200 dark:border-gray-700">
            ...
            <div class="w-full px-4 mb-4 md:w-1/4">
                ...
                <p class="text-base font-semibold leading-4 text-blue-600 dark:text-gray-400">₹157,495.00</p>
            </div>
            <div class="w-full px-4 mb-4 md:w-1/4">
                <p class="mb-2 text-sm leading-5 text-gray-600 dark:text-gray-400">Payment Method:</p>
                <p class="text-base font-semibold leading-4 text-gray-800 dark:text-gray-400">Cash on Delivery</p>
            </div>
        </div>
        ...
        <div class="flex flex-col sm:flex-row items-center justify-start gap-4 px-4 mt-6">
            <a href="/products"
                class="w-full sm:w-auto text-center px-4 py-2 text-blue-500 border border-blue-500 rounded-md hover:text-white hover:bg-blue-600 dark:border-gray-700 dark:hover:bg-gray-700 dark:text-gray-300">
                Go back shopping
            </a>
            <a href="/orders"
                class="w-full sm:w-auto text-center px-4 py-2 bg-blue-500 rounded-md text-gray-50 dark:text-gray-300 hover:bg-blue-600 dark:hover:bg-gray-700 dark:bg-gray-800">
                View My Orders
            </a>
        </div>
    </div>
