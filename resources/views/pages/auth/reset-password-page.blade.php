...
new #[Title('Reset Password | E-Commerce')] class extends Component {
    public $token;
    #[Url]
    public $email;
    public $password;
                ...
                <div class="p-4 sm:p-7">
                    ...
                    <div class="mt-5">
                        ...
                        <form wire:submit.prevent='save'>
                            @if (session('error'))
                                <div class="bg-red-500 text-sm text-foreground-inverse rounded-lg p-4 pb-4"
                            ...
                            <div class="grid gap-y-4">
                                ...
                                <div>
                                    ...
                                    @error('password')
                                        <p class="hidden text-red-600 mt-2" id="password-error">{{ $message }}
                                        </p>
                                    @enderror
                                </div>
                                <!-- End Form Group -->
